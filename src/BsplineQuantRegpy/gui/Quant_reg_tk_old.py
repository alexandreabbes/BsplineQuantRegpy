...
try:
    from PysplineQuantReg import  SplineLinearQuant
    print("✓ Module spline linéaire chargé")
except ImportError as e:
    print(f"✗ Erreur chargement spline lineaire: {e}")
    SplineLinearQuant = None

try:
    from PysplineQuantReg import   SplineQuadraticQuant
...
try:
    from PysplineQuantReg import   SplineQuarticQuant
