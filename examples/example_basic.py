...
def test_all_degrees():
    ...
    # Sans contrainte
    res_quart1 = SplineQuarticQuant(xtab, ytab, knots, tau, monot=0, cv=0, der3=0, solver='CLARABEL')
    
    # Croissante
    res_quart2 = SplineQuarticQuant(xtab, ytab, knots, tau, monot=1, cv=0, der3=0, solver='CLARABEL')
    
    # Convexe
    res_quart3 = SplineQuarticQuant(xtab, ytab, knots, tau, monot=0, cv=1, der3=0, solver='CLARABEL')
